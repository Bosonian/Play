  ...
  return (
    <form onSubmit={handleSubmit}>
      <input
        ...
        // calm/spare brief. Border shifts to the warm clay accent on focus.
        className="w-full bg-transparent border-b border-ink-ghost px-1 py-2 text-base text-ink placeholder:text-ink-fade focus:outline-none focus:border-clay"
        autoComplete="off"
