...
**Prüfung widget** shows **"Ready by {date}"** (coloured calm/tight/late, the same thresholds as the exam overview), then a thin weekly progress bar (added 0.40.0 — mirrors ExamOverview.tsx's own weekly bar, the ONE progress bar sanctioned elsewhere in this app; sky while this week's logged hours are still short of the required pace, emerald once they've met or passed it, and a genuinely empty track at 0% rather than a hidden bar), then this week's hours ("This week: 1.5 of 6.5 h"), then the exam anchor ("Exam window opens ..." or "Exam ..."), smallest and dimmest, last. Tapping it opens straight to the Prüfung overview.
